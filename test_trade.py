...
class TestMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.settlements = [self.test_settlement, self.test_settlement2, self.test_settlement3]
        self.connection_manager = connection_manager.ConnectionManager(level_map.GameMap(test=True), sound.Sound())
        ...
        self.test_price = 10
        self.test_ladder = trade.Ladder()

    
    def test_bid(self):
        self.test_bid = trade.Bid(self.test_settlement, self.test_good, self.test_magnitude, self.test_price)
        self.assertEqual(self.test_bid.bidder, self.test_settlement)
        
    def test_ask(self):
        self.test_ask = trade.Ask(self.test_settlement, self.test_good, self.test_magnitude, self.test_price)
        self.assertEqual(self.test_ask.asker, self.test_settlement)
        
    def test_ladder(self):        
        
        self.test_ladder.create_ladder_entry(self.test_settlement, self.test_good, self.test_magnitude, self.test_price, trade.EntryType.BID)
        self.assertEqual(len(self.test_ladder.bids),1)
        
        self.test_ladder.create_ladder_entry(self.test_settlement, self.test_good, self.test_magnitude, self.test_price, trade.EntryType.ASK)
    ...
    def test_ladder_resolve(self):
        ...
        self.test_good = "rubins"
        self.test_ladder.create_ladder_entry(self.test_settlement2, self.test_good, self.test_magnitude, self.test_price, trade.EntryType.ASK)
    ...
    def test_trading_form(self):
        ...
        self.test_bid = trade.Bid(self.test_settlement, self.test_good, self.test_magnitude, self.test_price)
        self.test_ask = trade.Ask(self.test_settlement2, self.test_good, self.test_magnitude, self.test_price)
    
        test_trading_form = trade.TradingForm(bidder=self.test_bid.bidder, asker=self.test_ask.asker, good=self.test_good, magnitude=self.test_magnitude,price=self.test_price)
    ...
    def test_buy_goods(self):
        ...
        test_trading_form = trade.TradingForm(good=self.test_good, magnitude=self.test_magnitude,price=self.test_price)
        ...
        test_trading_form = trade.TradingForm(magnitude=self.test_magnitude,price=self.test_price)
        is_affordable = self.test_settlement.settlement_goods.is_affordable(test_trading_form)
    ...
    def test_transaction(self):
        ...
        test_transaction_magnitude = self.test_trade.get_transaction_magnitudes(resolution.bid, resolution.ask)
